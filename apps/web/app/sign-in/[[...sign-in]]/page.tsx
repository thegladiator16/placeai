...
export const metadata: Metadata = {
  title: 'Sign in',
  description: 'Sign in to PlaceAI — your AI placement copilot.',
};
    ...
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2 bg-background">
      <div className="hidden md:flex flex-col justify-between p-10 lg:p-14 bg-gradient-to-br from-brand/10 via-background to-accent/5 border-r border-border/50">
        ...
        <div className="max-w-md">
          ...
          <h1 className="mt-6 text-4xl lg:text-5xl font-display font-bold text-foreground leading-tight">Land your dream job, <span className="text-gradient">not another rejection</span>.</h1>
        ...
        <p className="text-xs text-muted-foreground">New here? <Link href="/sign-up" className="text-brand hover:underline">Create an account →</Link></p>
      </div>
